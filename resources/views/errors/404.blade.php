...
<div class="min-h-screen flex items-center justify-center px-6">
    <div class="text-center">
        <div class="relative inline-block mb-8">
            <h1 class="text-[150px] md:text-[200px] font-black text-slate-100 leading-none">404</h1>
            <div class="absolute inset-0 flex items-center justify-center">
                <p class="text-2xl md:text-3xl font-black text-slate-900 uppercase tracking-widest">Halaman Hilang</p>
            </div>
        </div>
        <p class="text-slate-500 text-lg mb-12 max-w-md mx-auto">
            Sepertinya Anda tersesat di indahnya Sumatera Utara. Halaman yang Anda cari tidak dapat kami temukan.
        </p>
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="{{ route('contact') }}" class="bg-white text-slate-900 border border-slate-200 font-black py-4 px-8 rounded-2xl transition-all hover:bg-slate-50">
                Hubungi Kami
            </a>
        </div>
    </div>
